...
casper.then(function() {for (n=0; n<=2; n++)
...
// Mausklick auf Suchleiste
casper.then(function() {{techo('type gLFyf gsfi as '+farben[n]+'');
casper.waitFor(function check() {return check_tx('gLFyf gsfi');},
function then() {chrome.sendKeys(tx('gLFyf gsfi'),''+farben[n]+'');},
...
casper.then(function() {{techo('snap page to C:/Users/danie/Desktop/Bildschirmaufnahmen/'+farben[n]+'.png');
chrome.capture('C:/Users/danie/Desktop/Bildschirmaufnahmen/'+farben[n]+'.png');}});
