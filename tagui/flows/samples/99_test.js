...
casper.then(function() {{techo('click C:/tagui/flows/samples/windows.png'); var fs = require('fs');
if (!sikuli_step('click C:/tagui/flows/samples/windows.png')) if (!fs.exists('C:/tagui/flows/samples/windows.png') && !false)
this.echo('ERROR - cannot find image file C:/tagui/flows/samples/windows.png').exit(); else
this.echo('ERROR - cannot find C:/tagui/flows/samples/windows.png on screen').exit(); this.wait(0);}});
